 ...
 */
final class Version20180630093923 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, reference, max_points FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER NOT NULL, current_player_id INTEGER DEFAULT NULL, current_question_id INTEGER DEFAULT NULL, reference VARCHAR(36) NOT NULL COLLATE BINARY, max_points INTEGER NOT NULL, current_turn INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_232B318C42C04473 FOREIGN KEY (current_player_id) REFERENCES player (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CA0F35D66 FOREIGN KEY (current_question_id) REFERENCES question (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game (id, reference, max_points) SELECT id, reference, max_points FROM __temp__game');
